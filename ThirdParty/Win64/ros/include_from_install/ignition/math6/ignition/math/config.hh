...
#define IGNITION_MATH_MINOR_VERSION 9
#define IGNITION_MATH_PATCH_VERSION 2

#define IGNITION_MATH_VERSION "6.9"
#define IGNITION_MATH_VERSION_FULL "6.9.2"

#define IGNITION_MATH_VERSION_NAMESPACE v6

#define IGNITION_MATH_VERSION_HEADER "Ignition math, version 6.9.2\nCopyright (C) 2014 Open Source Robotics Foundation.\nReleased under the Apache 2.0 License.\n\n"

...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__init(rosbag2_storage_mcap_testdata__srv__BasicSrv_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->req)) {
    rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__fini(msg);
    return false;
  }
  return true;
}
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__create()
{
  ...
  rosbag2_storage_mcap_testdata__srv__BasicSrv_Request * msg = (rosbag2_storage_mcap_testdata__srv__BasicSrv_Request *)allocator.allocate(sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Request));
  bool success = rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__init(msg);
  if (!success) {
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence__init(rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_storage_mcap_testdata__srv__BasicSrv_Request * data = NULL;

  if (size) {
    data = (rosbag2_storage_mcap_testdata__srv__BasicSrv_Request *)allocator.zero_allocate(size, sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__fini(&data[i - 1]);
      }
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence__fini(rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence * array = (rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence *)allocator.allocate(sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence__init(array, size);
  if (!success) {
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence__destroy(rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence__are_equal(const rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence * lhs, const rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbag2_storage_mcap_testdata__srv__BasicSrv_Request * data =
      (rosbag2_storage_mcap_testdata__srv__BasicSrv_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbag2_storage_mcap_testdata__srv__BasicSrv_Request__copy(
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__init(rosbag2_storage_mcap_testdata__srv__BasicSrv_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->resp)) {
    rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_storage_mcap_testdata__srv__BasicSrv_Response * msg = (rosbag2_storage_mcap_testdata__srv__BasicSrv_Response *)allocator.allocate(sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Response));
  bool success = rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence__init(rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_storage_mcap_testdata__srv__BasicSrv_Response * data = NULL;

  if (size) {
    data = (rosbag2_storage_mcap_testdata__srv__BasicSrv_Response *)allocator.zero_allocate(size, sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence__fini(rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence * array = (rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence *)allocator.allocate(sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence__destroy(rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence__are_equal(const rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence * lhs, const rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosbag2_storage_mcap_testdata__srv__BasicSrv_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosbag2_storage_mcap_testdata__srv__BasicSrv_Response * data =
      (rosbag2_storage_mcap_testdata__srv__BasicSrv_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosbag2_storage_mcap_testdata__srv__BasicSrv_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }

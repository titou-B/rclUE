...
#ifndef ROSBAG2_STORAGE_MCAP_TESTDATA__MSG__DETAIL__COMPLEX_MSG_DEPENDS_ON_IDL__TRAITS_HPP_
#define ROSBAG2_STORAGE_MCAP_TESTDATA__MSG__DETAIL__COMPLEX_MSG_DEPENDS_ON_IDL__TRAITS_HPP_
...
inline void to_yaml(
  const rosbag2_storage_mcap_testdata::msg::ComplexMsgDependsOnIdl & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosbag2_storage_mcap_testdata::msg::ComplexMsgDependsOnIdl & msg)
{
  return rosbag2_storage_mcap_testdata::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rosbag2_storage_mcap_testdata::msg::ComplexMsgDependsOnIdl>()
{
  return "rosbag2_storage_mcap_testdata::msg::ComplexMsgDependsOnIdl";
}

template<>
inline const char * name<rosbag2_storage_mcap_testdata::msg::ComplexMsgDependsOnIdl>()
{
  return "rosbag2_storage_mcap_testdata/msg/ComplexMsgDependsOnIdl";
}

template<>
struct has_fixed_size<rosbag2_storage_mcap_testdata::msg::ComplexMsgDependsOnIdl>
  : std::integral_constant<bool, has_fixed_size<rosbag2_storage_mcap_testdata::msg::BasicIdl>::value> {};

template<>
struct has_bounded_size<rosbag2_storage_mcap_testdata::msg::ComplexMsgDependsOnIdl>
  : std::integral_constant<bool, has_bounded_size<rosbag2_storage_mcap_testdata::msg::BasicIdl>::value> {};

template<>
struct is_message<rosbag2_storage_mcap_testdata::msg::ComplexMsgDependsOnIdl>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROSBAG2_STORAGE_MCAP_TESTDATA__MSG__DETAIL__COMPLEX_MSG_DEPENDS_ON_IDL__TRAITS_HPP_

...
{
  new (message_memory) rosbag2_storage_mcap_testdata::msg::BasicIdl(_init);
}

void BasicIdl_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosbag2_storage_mcap_testdata::msg::BasicIdl *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BasicIdl_message_member_array[1] = {
  {
    ...
    offsetof(rosbag2_storage_mcap_testdata::msg::BasicIdl, x),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BasicIdl_message_members = {
  ...
  1,  // number of fields
  sizeof(rosbag2_storage_mcap_testdata::msg::BasicIdl),
...
{
  return &::rosbag2_storage_mcap_testdata::msg::rosidl_typesupport_introspection_cpp::BasicIdl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbag2_storage_mcap_testdata, msg, BasicIdl)() {
  return &::rosbag2_storage_mcap_testdata::msg::rosidl_typesupport_introspection_cpp::BasicIdl_message_type_support_handle;
}

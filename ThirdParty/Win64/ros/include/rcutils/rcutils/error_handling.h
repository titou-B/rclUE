...
// TODO: currently, if __STDC_VERSION__ is undefined (i.e. with MSVC),
// then this block of code will be ignored in its entirety,
// even if the compiler is configured to C++11 or above. As such,
// a platform-agnostic determination of the compiler version is needed.
